...
import com.hexagontk.http.mutable.model.Header
import com.hexagontk.http.mutable.model.QueryParameters
import com.hexagontk.http.mutable.model.Headers
import com.hexagontk.http.mutable.model.QueryParameter
...
internal class HttpTest {
    ...
    @Test fun `HTTP date has the correct format`() {
        ...
        val gmtDateTime = ZonedDateTime.of(localDateTime, Platform.zoneId).withZoneSameInstant(GMT_ZONE)
