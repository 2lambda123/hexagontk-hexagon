package com.hexagonkt.http.mutable
...
fun parseContentType(contentType: String): com.hexagonkt.http.mutable.model.ContentType {
    ...
    return when (typeParameter.size) {
        1 -> com.hexagonkt.http.mutable.model.ContentType(mimeType)
        2 -> {
            ...
            when (name.trim().lowercase()) {
                "boundary" -> com.hexagonkt.http.mutable.model.ContentType(mimeType, boundary = value)
                "charset" -> com.hexagonkt.http.mutable.model.ContentType(mimeType, charset = Charset.forName(value))
                "q" -> com.hexagonkt.http.mutable.model.ContentType(mimeType, q = value.toDouble())
