...
import com.hexagonkt.http.mutable.model.FORBIDDEN_403
import com.hexagonkt.http.mutable.model.UNAUTHORIZED_401
import com.hexagonkt.http.mutable.model.Header
...
internal class FiltersTest {
    ...
    private val path: PathHandler = path {
        filter("*") {
            ...
            response.headers += Header("time", time)
        }
        ...
        filter("/protected/*") {
            ...
            attributes += "username" to userPassword[0]
            attributes += "password" to userPassword[1]
            next()
        }
